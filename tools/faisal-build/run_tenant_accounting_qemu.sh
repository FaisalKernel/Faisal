...
[ "$qemu_rc" -ne 124 ]
for marker in FAISAL_M115_BOOT_OK M151_TENANT_CGROUP_OWNER_OK M151_TENANT_CGROUP_QUERY_OK M152_TENANT_CPU_THROTTLE_SET_OK M152_TENANT_CPU_STALE_GENERATION_DENY_OK M152_TENANT_CPU_THROTTLE_QUERY_OK M152_TENANT_CPU_THROTTLE_CLEAR_OK M153_TENANT_ACCELERATOR_RELEASE_UNDERFLOW_DENY_OK M153_TENANT_ACCELERATOR_MEMORY_RELEASE_OK M115_TENANT_BUDGET_SET_OK M115_TENANT_BUDGET_ADMISSION_DENY_OK M115_TENANT_BUDGET_QUERY_OK M115_TENANT_AGGREGATE_OK M115_TENANT_MALFORMED_REJECT_OK M115_TENANT_BUDGET_CLEAR_OK M151_TENANT_CGROUP_RELEASE_OK M115_SELFTEST_EXIT=0 M115_SELFTEST_RC=0; do
  grep -q "$marker" "$LOG"
done
