...
def main():
 ...
 if any(d.get('qualification_scope',{}).get(k) is True for k in ('physical_hardware','independent_builder','operator_signing_ceremony','external_security_review','external_multihost_replication','live_multihost_deployment','live_cve_operations')): fail('candidate scope falsely claims external qualification')
