...
def main() -> None:
    ...
    names = [
        ...
        'm244-continuous-optimization-supervisor-validation.json',
        'm245-platform-coordinator-validation.json',
        ...
        'frontier-agent-capability-possession-validation-2026-08-20.json',
        'frontier-agent-capability-revocation-validation-2026-08-20.json',
        ...
        'frontier-portable-memory-validation-2026-08-26.json',
        'frontier-model-routing-validation-2026-08-27.json',
        'frontier-model-routing-adaptive-validation-2026-08-28.json',
        'frontier-observation-trust-validation-2026-08-29.json',
        'frontier-trace-certification-validation-2026-08-30.json',
        'frontier-trace-conformance-validation-2026-08-31.json',
        'frontier-delegation-attenuation-validation-2026-09-01.json',
        'frontier-model-routing-evidence-bound-validation-2026-09-02.json',
        'frontier-hardware-qualification-evidence-quality-validation-2026-08-19.json',
        'frontier-model-routing-runtime-profile-validation-2026-08-19.json',
        'frontier-checkpoint-receipt-validation-2026-08-19.json',
        'frontier-memory-write-gate-validation-2026-08-19.json',
        'frontier-memory-read-gate-validation-2026-08-19.json',
        'frontier-handoff-receipt-validation-2026-08-19.json',
        ...
        'frontier-tool-authorization-validation-2026-08-19.json',
        'frontier-session-risk-validation-2026-08-19.json',
        'frontier-trace-segment-validation-2026-08-19.json',
        'frontier-migration-validation-2026-08-19.json',
        'frontier-path-governance-validation-2026-08-19.json',
        'frontier-intervention-validation-2026-08-19.json',
        'frontier-task-routing-validation-2026-08-19.json',
        'frontier-memory-promotion-validation-2026-08-19.json',
        'frontier-artifact-lineage-validation-2026-08-19.json',
        'frontier-delegation-chain-validation-2026-08-19.json',
        'frontier-capability-freshness-validation-2026-08-19.json',
        'frontier-interaction-ledger-validation-2026-08-19.json',
        'frontier-self-improvement-validation-2026-08-19.json',
        'frontier-evaluation-set-validation-2026-08-19.json',
        'frontier-evaluator-consensus-validation-2026-08-19.json',
        'frontier-evidence-freshness-validation-2026-08-19.json',
        'frontier-runtime-assurance-validation-2026-08-19.json',
        'frontier-kv-cache-admission-validation-2026-08-19.json',
        'frontier-tool-attestation-validation-2026-08-19.json',
        'frontier-intent-repair-validation-2026-08-19.json',
        'frontier-memory-intervention-validation-2026-08-19.json',
        'frontier-route-receipt-validation-2026-08-19.json',
        'frontier-handoff-authorization-validation-2026-08-19.json',
        'frontier-interrupt-fence-validation-2026-08-19.json',
        'frontier-qualification-intake-validation-2026-08-19.json',
        'frontier-signing-ceremony-validation-2026-08-19.json',
        'frontier-physical-hardware-matrix-validation-2026-08-19.json',
        'frontier-independent-security-review-validation-2026-08-19.json',
        'frontier-live-multihost-qualification-validation-2026-08-19.json',
        'frontier-evidence-index-validation-2026-08-19.json',
