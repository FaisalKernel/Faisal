...
18. **M87 runtime-verification signal integration and attested repair gating:** next selected dependency; integrate runtime-verification signals with the M86 attestation digest, bind signed content-addressed repair bundles to trusted provenance, preserve provider-gated attestation, and validate security, benchmark, and rollback behavior without enabling arbitrary kernel self-modification.
