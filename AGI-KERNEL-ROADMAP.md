...
| Latest tagged FAISAL milestone | `FAISAL-M88`, kernel Runtime Verification signal bridge |
| Kernel ABI | 37 |
...
| Next selected dependency | M89 concurrent sanitizer and lockdep validation for the M88 RV bridge |
...
20. **M89 concurrent sanitizer and lockdep validation for the M88 RV bridge:** next selected dependency; build dedicated KASAN/KCSAN/lockdep RV kernels and exercise concurrent report/open/release, malformed consumers, security gates, and regression coverage.
