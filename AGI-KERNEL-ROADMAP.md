...
| Latest tagged FAISAL milestone | `FAISAL-M89`, concurrent RV bridge sanitizer validation |
| Kernel ABI | 37 |
...
| Next selected dependency | M90 production key provisioning, rotation, revocation, and signed-bundle verification contract |
...
21. **M90 production key provisioning, rotation, revocation, and signed-bundle verification contract:** next selected dependency; keep private signing keys in a bounded userspace/provider boundary, bind verification to independent approval and deployment digests, and preserve the model-output non-authority rule.
