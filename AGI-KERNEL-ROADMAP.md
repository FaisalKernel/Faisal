...
10. **M79 provider-gated heterogeneous accelerator validation:** validate the existing accelerator/context/tensor/transport/resource abstractions against real supported hardware or an explicitly identified provider; do not infer hardware capability from metadata or QEMU.
