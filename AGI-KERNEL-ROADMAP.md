...
29. **M98 tool registry and risk/cost contract:** next selected dependency. Define capability-scoped tool identity, risk and cost metadata, provenance, verification, revocation, and independent approval; model output remains non-authoritative.
