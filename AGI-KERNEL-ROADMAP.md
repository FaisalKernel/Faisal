...
17. **M83 transactional persistent-memory concurrency and crash-safe cross-journal rollback:** next selected dependency; add atomic multi-journal commit, concurrent read/write, crash injection, rollback replay, capability isolation, security review, benchmark, and regression evidence before claiming transactional persistent memory.
