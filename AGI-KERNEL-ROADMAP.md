...
25. **M94 supervisor-mediated provider ownership and explicit crash recovery:** next selected dependency. Define the smallest supervisor-mediated ownership, stale-service reclamation, and restart contract; do not infer recovery from process disappearance or add durable private-key storage without an identified provider.
