...
| Latest tagged FAISAL milestone | `FAISAL-M91`, provider-gated hardware attestation boundary |
| Kernel ABI | 37 |
...
| Next selected dependency | M92 userspace key-provider fuzz, concurrency, and lifetime hardening |
...
23. **M92 userspace key-provider fuzz, concurrency, and lifetime hardening:** next selected dependency; fuzz M90 metadata and state transitions under sanitizers while preserving M91’s explicit unsupported hardware gate.
