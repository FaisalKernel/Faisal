...
11. **M80 cross-subsystem stress, fuzz, and failure-injection hardening:** exercise long-running composition, malformed UAPI boundaries, cancellation, recovery, resource pressure, audit retention, and rollback under repeated fault injection before any later provider-specific or production claim.
