...
30. **M99 tool registry and execution broker:** next selected dependency. Define capability-scoped tool identity, risk and cost metadata, provenance, verification, revocation, per-invocation authority, independent approval, and irreversible-side-effect handling; model output remains non-authoritative.
