...
15. **M81 concurrent lifecycle and IPC stress with sanitizer-enabled kernel validation:** next selected dependency; add concurrent stress and randomized structured inputs, then use KASAN/KCSAN/lockdep or record explicit infrastructure blockers before further production claims.
