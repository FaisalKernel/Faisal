...
**Current tagged milestone:** `FAISAL-M99`
...
The next selected dependency is **M100 verified deterministic tool-adapter sandbox**. It must begin with a non-network fixture and prove adapter identity, sandbox isolation, effect scoping, input/output sanitization, idempotency, revocation, verification receipts, independent approval, fault injection, security, benchmark, and full-regression evidence before any irreversible filesystem, network, browser, payment, deployment, or device effect is exposed.

## Governance

The program maintains small, reviewable commits and milestone tags. Every change records affected subsystems, compatibility impact, security impact, tests, benchmarks, and rollback. Unrelated untracked work is never silently included in a milestone. M73, M74, M75, M76, M77, M78, M79, M80, M81, M82, M83, M84, M85, M86, M87, M88, M89, M90, M91, M92, M93, M94, M95, M96, M97, M98, and M99 evidence is stored under `tools/faisal-build/evidence/`, including machine-readable validation, QEMU, regression, benchmark, sanitizer, and build records. The active program state is updated after meaningful implementation, validation, failure, or dependency changes.
